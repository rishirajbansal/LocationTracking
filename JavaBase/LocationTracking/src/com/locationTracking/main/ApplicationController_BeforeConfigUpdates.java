...
public class ApplicationController_BeforeConfigUpdates {
	...
	public static void main(String[] args){
		...
		try{
			...
			if (Utility.safeTrim(multiThreadedMode).equals(Constants.STRING_TRUE)){
				...
				//ThreadManager threadManager = ThreadManager.instantiate(Integer.parseInt(threadPoolSize));
				logger.info("Thread Pool Manager started successfully.");
				
				/*Call Business Engine*/
				//engine = BusinessEngine.instantiate(threadManager);
				...
				ApplicationController_BeforeConfigUpdates.registerShutdownHook(engine);
			...
			while (running){
				...
				logger.info("________________________________________ COMPLETED !!!!_______________________________________________");
				logger.info(" ");
