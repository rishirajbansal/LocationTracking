...
$flag = $adminMgmtDAO->fetchDBConfig();
...
if (!$flag){
    ...
    $allConfig = $adminMgmtDAO->getDBConfig();
}
...
if (isset($_POST['submit'])){
    ...
    if ($action['result'] != 'error'){
        ...
        $updateFlag = $adminMgmtDAO->updateDBConfig($inputs);
        ...
        if ($updateFlag){
            ...
            if ($flag){
                ...
                array_push($text,'Database configuration updated successfully.');
                $action['text'] = $text;
            }
            else{
                $action['result'] = 'error'; 
    ...
    <body >
        ...
        <header class="jumbotron subhead" id="overview">
            <div class="container" style="padding-left: 35px;margin-left: inherit"> 
              <h1 style="font-size:27px">System - Database Configuration</h1>
              <p class="lead" style="font-size:17px">Database Configuration settings for Backend Program</p>
           </div>
        </header>
        ...
        <div class="container-fluid " style="padding-top: 30px; min-height: 600px ">
            ...
            <form class="form-inline" id="generalDBForm" name="generalDBForm" method="post" action="">
