...
if (isset($_POST['submit'])){
    ...
    if ($action['result'] != 'error'){
        ...
        $isValid = $locationHistoryDAO->login($inputs);

        if ($isValid){
            session_start();
            $_SESSION['loggedIn'] = 1;
            $_SESSION['begin'] = time();
            $_SESSION['user'] = $locationHistoryDAO->getLoggedInUser();
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Location History &middot; Login</title>
    ...
    <body >
        ...
        <header class="jumbotron subhead" id="overview">
            <div class="container" style="padding-left: 35px;margin-left: inherit"> 
              <h1 style="font-size:27px">Login</h1>
              <p class="lead" style="font-size:17px">Login verification process to access the application</p>
           </div>
        </header>
                ...
                if ( $action['result'] == 'error' ) { ?>
                    ...
                    <div class="alert alert-error" style="text-align: center;">
                      ...
                      <br/><br/>
                       ...
                       <br/>
                       <p style="font-size: 16px;" >Also check if the domain name is correct.</p>
                    ...
                    <div class="well sidebar-nav" style="min-height: 200px;margin-left: 0px;">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <a href="fgtPwd.php" style="float: right; margin-right: 15px; font-size: 15px;margin-top: 12px;"><b>Forgot Password ?</b></a>
                                </div>
                            </div>
