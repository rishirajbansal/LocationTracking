...
if (isset($_POST['submit'])){
    ...
    if ($action['result'] != 'error'){
        ...
        $user = new User();
        $user = $_SESSION['user'];
        $inputs->setUserid($user->getUserId());
        $saveFlag = $locationHistoryDAO->changePassword($inputs);
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Location History &middot; My Account</title>
    ...
    <body >
        ...
        <header class="jumbotron subhead" id="overview">
            <div class="container" style="padding-left: 35px;margin-left: inherit"> 
              <h1 style="font-size:27px">Change Password</h1>
              <p class="lead" style="font-size:17px">Replace Password with new</p>
           </div>
        </header>
        ...
        <div class="container" style="padding-top: 30px; min-height: 600px ">
            ...
            <form class="form-horizontal" id="changePwdForm" name="changePwdForm" method="post" action="">
                ...
                if ( $action['result'] == 'success' ) { ?>
                    ...
                    <div class="alert alert-info" style="text-align: center;">
                        ...
                        <p class="lead"><h3 style="color: #1886AA;text-shadow: 2px 2px #FFFFFF;">Password has been updated successfully.</h3></p>
...
function preventSQLInjectionAndValidate(Inputs $inputs){
    ...
    $inputs->setU_oldPassword($oldpassword);
    $inputs->setU_newPassword($newpassword);
