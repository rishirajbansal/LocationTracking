...
<!DOCTYPE html >
  <head>
    ...
    /*var customIcons = {
      worker: {
        icon: 'http://google.com/mapfiles/kml/paddle/'
      },
      project: {
      ...
      downloadUrl('<?php echo $_GET['filename']; ?>', function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
          ...
          if (type == 'project'){
              ...
              image = 'http://maps.google.com/mapfiles/kml/pal2/icon5.png';
          }
          else{
              html = "<b>" + name + "</b> <br/> <br/><u>Last Recorded</u> : " + time + "<br/>  <br/><u>Location</u> :  " + location;
              //icon = 'http://maps.gstatic.com/mapfiles/kml/paddle/' + ctr + '.png';
              var image = new google.maps.MarkerImage('public_html/../img/markers/marker' + ctr + '.png',
  ...
  <body onload="load()">
    <div id="map" style="width: auto; height: 880px;border: 2px solid rgb(58, 135, 173);border-radius: 4px;"></div>
  </body>
